...
contract ShiaInu2 is Context , IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1000000000000 * 10**_decimals; // 1 trillion max supply
    string private constant _name = "ShiaInu 2.0" ;
    string private constant _symbol = "$SINU2" ;
    uint256 public _maxTxAmount = 30000000000 * 10**_decimals; // 3% of the supply
    uint256 public _maxWalletSize = 50000000000 * 10**_decimals; // 5% of the supply
