...
contract SWORDS is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"⚔️", unicode"⚔️") {
        ...
        marketingWallet = address(0xFa74eA272c358a8158f64F7634f0a2a7919C93EF); // set as marketing wallet
        devWallet = address(0xFa74eA272c358a8158f64F7634f0a2a7919C93EF); // set as dev wallet
