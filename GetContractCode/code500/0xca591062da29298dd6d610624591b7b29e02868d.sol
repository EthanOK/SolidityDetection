...
contract CCDS is Context, IERC20, Ownable {
    ...
    address payable private _mwWallet = payable(0x42f124Cd7B639Aa07bd1E03fB34a88c96306063A);
    address payable private _prWallet = payable(0x42f124Cd7B639Aa07bd1E03fB34a88c96306063A);
    ...
    string private constant _name = unicode"CCDS";
    string private constant _symbol = unicode"CCDS";
