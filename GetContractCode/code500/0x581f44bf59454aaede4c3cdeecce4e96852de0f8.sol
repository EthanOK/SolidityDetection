...
// SPDX-License-Identifier: MIT
 ...
 /** ///////////////
TESTING CONTRACT LEARNING SOLIDITY TESTING TAX FUNCTIONS 
DO NOT BUY 
*/ ///////////////        
...
contract TESTTOKEN is Context, IERC20, Ownable {
    ...
    string private constant _name = "TESTING TOKEN DONT BUY";
    ...
    uniswapV2Pair = IUniswapV2Factory(uniswapV2Router.factory()).createPair(address(this), uniswapV2Router.WETH());
         MarketingWallet = payable(0x2f065014fb7EeDCd49bf7E0a4756d698767B06f0);
