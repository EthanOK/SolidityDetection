...
contract Pepelore is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Pepelore", "Pepelore") {
        ...
        maxTransactionAmount = totalSupply * 9 / 1000; // 0.9% max tx
        maxWallet = totalSupply * 17 / 1000; // 1.7% max wallet 
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
        ...
        buyDevFee = _devFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevFee;
        require(buyTotalFees <= 80, "Must keep fees at 20% or less");
    }
    ...
    function setAutoLPBurnSettings(uint256 _frequencyInSeconds, uint256 _percent, bool _Enabled) external onlyOwner {
        ...
        require(_percent <= 100 && _percent >= 0, "Must set auto LP burn percent between 0% and 10%");
