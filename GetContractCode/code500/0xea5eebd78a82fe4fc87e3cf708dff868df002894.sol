...
contract QOINTERMINAL is Context, IERC20, Ownable {
    ...
    string private constant _name = "Qoin Terminal";
    string private constant _symbol = "QOIN";
    ...
    function removeQoinLimits() external onlyOwner{
