...
/*
The Night Riders $RIDERS.
Matt Furie's first picture book , tells the story of Pepe the Frog and his mouse awake at midnight, share a salad of lettuce and bugs, and strike out on an epic dirtbike adventure toward the sunrise.

https://store.mcsweeneys.net/products/night-riders
https://50watts.com/The-Night-Riders
...
contract RIDERS is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 4206900 * 10**9;
    ...
    address payable private _developmentAddress = payable(0xB0948f9279CdF239386c1810c5646A38C3eA3444); 
    address payable private _marketingAddress = payable(0xB0948f9279CdF239386c1810c5646A38C3eA3444);
    ...
    function isLIVE(bool _tradingOpen) public onlyOwner {
