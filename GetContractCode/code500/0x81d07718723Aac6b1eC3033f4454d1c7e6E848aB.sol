...
/**
Vitalik Not Got Hacked

Proto-Danksharding Is Real : 
...
contract ProtoDankshardingIsReal is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Proto-Danksharding Is Real";
    string private constant _symbol = unicode"VITALIK NOT HACKED";
