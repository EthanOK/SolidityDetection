...
// File: contracts\0x80f64f180abb9620b6b80bf440e6e445a6004b8b,VerityOne,VERITY,2023-09-09_14-36-11.sol

 
pragma solidity ^0.8.0;
contract VerityOne is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable {
    function decimals() public view virtual override returns (uint8) {
            return 18;
            }
    mapping(address => bool) internal _blacklist;

    constructor() ERC20("Verity One", "VERITY") {
