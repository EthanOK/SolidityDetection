...
def getsccode():
    try:
        SCAddress = open("E:\\SmartContract\\ContractCrawler\\address\\address.txt", "r")
...
def getSCAddress(eachurl, filepath):
    ...
    for targetTR in targetTBody:
        ...
        if targetTR.name == 'tr':
            ...
            fo.write("https://cn.etherscan.com" + targetTR.td.find('a', 'hash-tag text-truncate').attrs['href']
...
def updatescurl():
    urlList = ["https://cn.etherscan.com/contractsVerified/1?ps=100",
    "https://cn.etherscan.com/contractsVerified/2?ps=100",
    "https://cn.etherscan.com/contractsVerified/3?ps=100",
    "https://cn.etherscan.com/contractsVerified/4?ps=100",
    "https://cn.etherscan.com/contractsVerified/5?ps=100"]
